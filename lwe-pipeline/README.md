...
node lwe-pipeline/generate.mjs wire        # rewrite the registry-driven regions (sitemap, buddy list, nav, ask.js CONCEPTS)
node lwe-pipeline/build-corpus.mjs         # rebuild the ask corpus from lwe-ask/corpus/<concept>.json
