---
title: "aadhar.sh/lwe/drivers"
description: "Planar magnetic versus dynamic headphone drivers, explained at MSN-chat pace. A live diaphragm-motion demo: a dynamic cone driven at one point breaks up at high frequency, while a planar film driven everywhere stays flat."
path: "/lwe/drivers"
section: "lwe"
kind: "content"
updated: "2026-06-22"
source: "https://aadhar.sh/lwe/drivers"
---

**drivers**Online, point drive vs distributed drive

Learning With Errors
cones & films

**Starter draft.** The mechanism is standard driver physics; the demo is a real phase-lag model (a cone driven at one point against a film driven everywhere), not a measurement. Background paraphrased from [Wikipedia](https://en.wikipedia.org/wiki/Magnetostatic_loudspeaker) and the usual headphone references.
...
→ [planar magnetic on Wikipedia](https://en.wikipedia.org/wiki/Magnetostatic_loudspeaker) · [headphones on Wikipedia](https://en.wikipedia.org/wiki/Headphones) · [back to Learning With Errors](https://aadhar.sh/lwe)
