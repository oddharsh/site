#!/usr/bin/env bash
# bump-checkpoint.sh — stage a release entry for /updates and /restore.
#
...
OUT="$ROOT/content/data/checkpoints.json"
...
echo "next:   commit content/data/checkpoints.json with the change it describes."
