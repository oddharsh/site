...
//
//   node scripts/verify-routes.mjs [baseUrl]      # default https://aadhar.sh
//   node scripts/verify-routes.mjs http://localhost:8788
//
...
async function main() {
  ...
  if (isProd) {
    ...
    outFile = `scripts/verify-baseline.${host}.json`;
