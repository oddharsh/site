...
//
//   node scripts/gen-remote-config.mjs wrangler.dev.jsonc            # dev twin
//   node scripts/gen-remote-config.mjs wrangler.jsonc --out x.jsonc  # oracle twin
//   node scripts/gen-remote-config.mjs wrangler.dev.jsonc --d1       # opt into D1
//
...
await writeFile(
  out,
  "// GENERATED by scripts/gen-remote-config.mjs — do not edit, do not commit.\n" +
