...
export function renderBotPage() {
  const css = `h1{color:oklch(41.92% .0962 250.51);margin:0 0 4px;font-family:Trebuchet MS,Verdana,Geneva,sans-serif;font-size:14pt;font-weight:700}h2{color:oklch(41.92% .0962 250.51);margin:16px 0 6px;font-family:Trebuchet MS,Verdana,Geneva,sans-serif;font-size:12pt;font-weight:700;line-height:1.3}h2:after{content:"";background:oklch(86.67% .0294 259.59);height:1px;margin-top:8px;display:block}a:link{color:oklch(42.61% .2353 263.74);text-decoration:underline}a:visited{color:oklch(42.09% .1935 328.36)}a:hover{color:oklch(62.8% .2577 29.23)}code{background:oklch(96.72% 0 0);border:1px solid oklch(88.22% 0 0);padding:0 3px;font-family:Courier New,Courier,monospace}.lede{color:oklch(38.67% 0 0);margin:0 0 12px;font-size:10.5pt}dl.fields{background:oklch(85.04% .0283 248.16);border:1px solid oklch(61.14% .0611 253.6);border-color:oklch(47.12% .0555 253.58) oklch(61.14% .0611 253.6) oklch(61.14% .0611 253.6) oklch(47.12% .0555 253.58);grid-template-columns:11em 1fr;gap:1px;margin:4px 0 14px;font-size:10pt;display:grid}dl.fields dt{color:oklch(41.92% .0962 250.51);background:oklch(94.66% .0114 252.09);padding:4px 8px;font-weight:700}dl.fields dd{word-break:break-all;background:oklch(100% 0 0);margin:0;padding:4px 8px;font-family:Courier New,Courier,monospace;font-size:9.5pt}footer{text-align:center;color:oklch(44.95% 0 0);border-top:1px solid oklch(86.67% .0294 259.59);margin-top:16px;padding-top:10px;font-size:9pt}`;
  const body = `
    <h1>${BOT_NAME}</h1>
    <p class="lede">
