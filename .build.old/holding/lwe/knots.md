---
title: "aadhar.sh/lwe/knots"
description: "Why your shoelaces come undone, explained at MSN-chat pace. Granny versus square, the Ian knot, and bunny ears, with a live demo: toggle the second crossing's handedness and pull to watch one lock and the other slip."
path: "/lwe/knots"
section: "lwe"
kind: "content"
updated: "2026-06-22"
source: "https://aadhar.sh/lwe/knots"
---
...
**knots**Online, granny vs square, and the Ian knot

Learning With Errors  
two crossings

**Starter draft.** The granny-versus-square structure is standard knot lore; the demo is a schematic of the two crossings, not a rope simulation. Background paraphrased from [Ian's Shoelace Site](https://www.fieggen.com/shoelace/ianknot.htm) and Wikipedia.
...
granny vs square · toggle the second crossing, then pull
...
**Square (reef).** The second crossing mirrors the first, so the knot seats flat and each rope nips the other. Pull and it locks.
...
[\[src\]](https://www.fieggen.com/shoelace/ianknot.htm)

**aadharsh**21:14

and bunny ears? that's what I learned as a kid.
...
→ [Ian's Shoelace Site](https://www.fieggen.com/shoelace/ianknot.htm) · [reef knot on Wikipedia](https://en.wikipedia.org/wiki/Reef_knot) · [shoelace knot on Wikipedia](https://en.wikipedia.org/wiki/Shoelace_knot) · [back to Learning With Errors](https://aadhar.sh/lwe)

end of first pass

This is a recorded conversation. Toggle and pull in the demo above.
