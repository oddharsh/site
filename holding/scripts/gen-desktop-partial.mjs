...
const sprite = `<svg xmlns="http://www.w3.org/2000/svg" width="${spriteW}" height="${spriteH}" viewBox="0 0 ${spriteW} ${spriteH}">` +
  ...
  " Served from /a/ as plain brotli, never as a dcz dictionary delta: a delta consumed by the image loader blanked" +
  " every icon in warm Chromium. See DICTIONARY_TYPES in _worker.js/lib/assets.js. -->" +
