...
// Build holding/images/exif.json: every photo's EXIF in ONE file, with the
...
const META = path.join(ROOT, "holding/images/meta");
const OUT = path.join(ROOT, "holding/images/exif.json");
