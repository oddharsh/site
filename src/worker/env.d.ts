/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.rewrite.jsonc src/worker/env.d.ts` (hash: 7639c2b4532ea98c8db67aeeae4ceba7)
...
interface __BaseEnv_Env {
	...
	BOOKING_SLOTS: DurableObjectNamespace<import("./index").BookingSlot>;
	BOOKING_WORKFLOW: Workflow<Parameters<import("./index").BookingWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "Counter" | "BookingSlot";
	}
