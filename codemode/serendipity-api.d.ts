...
export function list_events(args?: { when?: "upcoming" | "past" | "all"; rsvp?: "going" | "all" | "discovered"; q?: string; limit?: number }): Promise<any>;
...
export function get_event(args?: { id: string }): Promise<any>;
...
export function search_people(args?: { q: string; limit?: number }): Promise<any>;
...
export function list_contributors(): Promise<any>;
...
export function contributor_events(args?: { contributor: string }): Promise<any>;
...
export function frequent_people(args?: { when?: "upcoming" | "past" | "all"; limit?: number }): Promise<any>;
...
export function co_attendees(args?: { q: string; limit?: number }): Promise<any>;
...
export function connections(args?: { min_shared?: number; limit?: number }): Promise<any>;

/** Given two people by name, the events they both attended (did these two cross paths, and where). */
export function shared_events(args?: { a: string; b: string }): Promise<any>;
