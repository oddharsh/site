...
const outputs = [["window.ts", "typescript"], ["property-sheet.ts", "typescript-property-sheet"], ["explorer-list.ts", "typescript-explorer-list"], ["taskbar.ts", "typescript-taskbar"]].map(([file, mode]) => ({
