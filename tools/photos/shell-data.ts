...
export const TRAY_ITEMS = [
  ...
  // Ships HIDDEN, like #axp-sound above it. The icon claims "an agent can drive
  // this page", and that is only true in a browser that implements WebMCP, so
  // webmcp.js unhides it once tools are actually registered. A tray icon that
  // appeared for a Safari visitor with no modelContext would be decoration.
  {
    id: "axp-webmcp", kind: "webmcp", href: "/whoareyou", hidden: true,
    title: "Agent activity \u00b7 what an agent has asked this page to do", label: "Agent activity",
    svg: '<svg viewBox="0 0 24 24"><defs><filter id="wmSh" x="-30%" y="-20%" width="160%" height="150%"><feDropShadow dx="0" dy=".5" stdDeviation=".5" flood-color="#000" flood-opacity=".28"></feDropShadow></filter><linearGradient id="wmPad" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#fbf8ee"></stop><stop offset=".55" stop-color="#e7e1cd"></stop><stop offset="1" stop-color="#c8c1a8"></stop></linearGradient><linearGradient id="wmBar" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#6fb0e8"></stop><stop offset=".5" stop-color="#2f72b6"></stop><stop offset="1" stop-color="#16548f"></stop></linearGradient><linearGradient id="wmChip" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#74cf52"></stop><stop offset="1" stop-color="#2c861d"></stop></linearGradient><linearGradient id="wmGl" x1="0" y1="0" x2="0" y2="1"><stop offset="0" stop-color="#ffffff" stop-opacity=".55"></stop><stop offset="1" stop-color="#ffffff" stop-opacity="0"></stop></linearGradient></defs><g filter="url(#wmSh)"><rect x="3.2" y="2.4" width="15.6" height="19.2" rx="1.8" fill="url(#wmPad)" stroke="#8b8268" stroke-width=".55"></rect><rect x="3.95" y="3.15" width="14.1" height="17.7" rx="1.3" fill="none" stroke="#ffffff" stroke-opacity=".55" stroke-width=".5"></rect><rect x="5.2" y="4.3" width="11.6" height="3.4" rx=".7" fill="url(#wmBar)"></rect><path d="M5.2 4.3 H16.8 V5.9 Q11 7.6 5.2 6.2 Z" fill="url(#wmGl)"></path><g fill="none" stroke="#6d6753" stroke-width="1.1" stroke-linecap="round"><path d="M5.9 10.2 H16.1"></path><path d="M5.9 12.9 H14"></path><path d="M5.9 15.6 H15.2"></path></g><circle cx="18" cy="18.2" r="4.3" fill="url(#wmChip)" stroke="#ffffff" stroke-width=".9"></circle><path d="M15.9 18.3 L17.4 19.8 L20.2 16.6" fill="none" stroke="#ffffff" stroke-width="1.35" stroke-linecap="round" stroke-linejoin="round"></path></g></svg>',
  },
];
