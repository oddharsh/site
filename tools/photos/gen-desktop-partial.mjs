...
//
//   node tools/photos/gen-desktop-partial.mjs
...
export function renderDesktopArtifacts(surfaces = readManifest().surfaces) {
  ...
  // one. Measured on 2026-08-16, when moving www/scripts to tools/photos did
  // exactly that and failed the build invariant.
  const moduleSource = `// lib/desktop.js — the static XP desktop shell, GENERATED by\n`
    + `// tools/photos/gen-desktop-partial.mjs from shell-data.mjs and\n`
  ...
  const sprite = `<svg xmlns="http://www.w3.org/2000/svg" width="${spriteWidth}" height="${spriteHeight}" viewBox="0 0 ${spriteWidth} ${spriteHeight}">`
    + "<!-- GENERATED by gen-desktop-partial.mjs from shell-data.mjs. Do not hand-edit. Served from /a/ as plain brotli, never as a dcz dictionary delta; see DICTIONARY_TYPES in _worker.js/lib/assets.js. -->"
