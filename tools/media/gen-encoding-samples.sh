...
#
#   ./tools/media/gen-encoding-samples.sh [STEM] [SRC_DIR_OR_FILE]
...
DEST="$PROJECT_DIR/assets/studies/encoding"
STEM="${1:-XT509338}"
...
echo ""; echo "done — review the generated assets and update content/pages/garage/encoding.md if the measurements changed."
