...
// Build assets/photos/data/exif.json: every photo's EXIF in ONE file, with the
...
const META = path.join(ROOT, "assets/photos/data/meta");
const OUT = path.join(ROOT, "assets/photos/data/exif.json");
