...
//
//     BROWSER_RUN_TOKEN=... bun run kitesurf:check          # free probes only
//     BROWSER_RUN_TOKEN=... bun run kitesurf:check --render
//
...
async function main() {
  ...
  if (verdict === null && !WANT_RENDER) {
    ...
    console.log("  BROWSER_RUN_TOKEN=... bun run kitesurf:check --render");
    process.exit(1);
  }
